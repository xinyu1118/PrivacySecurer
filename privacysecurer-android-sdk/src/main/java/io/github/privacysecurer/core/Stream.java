...
/**
 * Stream is one of the essential classes used in privacysecurer.
 * Most personal data access/process operation in privacysecurer use Stream as the intermediate.
 *
